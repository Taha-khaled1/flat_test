...
class S {
  ...
  /// `The Code is wrong`
  String get the_code_is_wrong {
    return Intl.message(
      'The Code is wrong',
      name: 'the_code_is_wrong',
      desc: '',
      args: [],
    );
  }
  ...
  String get complete_the_purchase {
    return Intl.message(
      'Complete the purchase',
      name: 'complete_the_purchase',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Click to pay online`
  String get click_to_pay_on_my_fatoorah {
    return Intl.message(
      'Click to pay online',
      name: 'click_to_pay_on_my_fatoorah',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Pay online`
  String get pay_on_my_fatoorah {
    return Intl.message(
      'Pay online',
      name: 'pay_on_my_fatoorah',
      desc: '',
      args: [],
    );
  }
