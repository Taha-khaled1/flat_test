...
import 'package:turkey_app/src/pages/mobile_verification.dart';
import 'package:turkey_app/src/pages/mobile_verification_2.dart';
import 'package:turkey_app/src/pages/phone_login.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/PayMyFatoorah':
        return MaterialPageRoute(builder: (_) => OrderSuccessWidget(routeArgument: RouteArgument(param: 'Pay on My Fatoorah')));
      case '/PayPal':
