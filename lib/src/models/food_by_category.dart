...
//
//     final foodsByCategory = foodsByCategoryFromJson(jsonString);

import 'dart:convert';

FoodsByCategory foodsByCategoryFromJson(String str) => FoodsByCategory.fromJson(json.decode(str));

String foodsByCategoryToJson(FoodsByCategory data) => json.encode(data.toJson());
...
class FoodsByCategory {
  ...
  factory FoodsByCategory.fromJson(Map<String, dynamic> json) => FoodsByCategory(
