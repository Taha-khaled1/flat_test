...
//
//     final homeFoods = homeFoodsFromJson(jsonString);

import 'dart:convert';

HomeFoods homeFoodsFromJson(String str) => HomeFoods.fromJson(json.decode(str));

String homeFoodsToJson(HomeFoods data) => json.encode(data.toJson());
...
class HomeFoods {
  ...
  factory HomeFoods.fromJson(Map<String, dynamic> json) => HomeFoods(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    foods: json["foods"] == null ? null : List<Foodies>.from(json["foods"].map((x) => Foodies.fromJson(x))),
  );
...
class Foodies {
  ...
  factory Foodies.fromJson(Map<String, dynamic> json) => Foodies(
    id: json["id"] == null ? null : json["id"],
    name: json["name"] == null ? null : json["name"],
