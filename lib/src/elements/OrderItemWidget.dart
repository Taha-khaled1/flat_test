    ...
    return Stack(
      children: <Widget>[
              ...
              Container(
                child: Wrap(
                  ...
                  children: <Widget>[
                    MaterialButton(
                      onPressed: () {
                        Navigator.of(context).pushNamed('/Tracking', arguments: RouteArgument(id: widget.order.id.toString()));
                      },
        ...
        Container(
          ...
          width: 140,
          decoration: BoxDecoration(
              borderRadius: BorderRadius.all(Radius.circular(100)), color: widget.order.active ? Theme.of(context).colorScheme.secondary : Colors.redAccent),
