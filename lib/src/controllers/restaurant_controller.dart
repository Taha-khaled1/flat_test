...
class RestaurantController extends ControllerMVC {
  ...
  Future<dynamic> listenForRestaurant(BuildContext context,
  ...
  void listenForFeaturedFoods(String idRestaurant, BuildContext context) async {
    final Stream<Food> stream =
  ...
  Future<void> listenForCategories(
