...
class DeliveryAddressesController extends ControllerMVC with ChangeNotifier {
  ...
  Future<void> refreshAddresses() async {
    addresses.clear();
    listenForAddresses(context,
        message: S.of(context).addresses_refreshed_successfuly);
  }
  ...
  void removeDeliveryAddress(
    ...
    userRepo.removeDeliveryAddress(address).then((value) async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setString('address_id', null);
      prefs.setString('address_desc', null);
      prefs.setString('address_adress', null);
      prefs.setDouble('address_lat', null);
      prefs.setDouble('address_lng', null);
      setState(() {
